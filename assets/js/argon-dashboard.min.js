...
let iconNavbarSidenav = document.getElementById("iconNavbarSidenav"),
    ...
    body = document.getElementsByTagName("body")[0], className = "g-sidenav-pinned";
...
let indicators = document.querySelectorAll(".indicator"), sections = document.querySelectorAll("section");
if (indicators) {
    let t = () => {
    ...
    indicators.forEach(e => {
        e.addEventListener("click", function (e) {
            e.preventDefault(), document.querySelector(this.getAttribute("href")).scrollIntoView({behavior: "smooth"}), t(), this.classList.add("active")
        })
    }), sections.forEach(e)
}
